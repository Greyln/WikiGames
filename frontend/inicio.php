    ...
    <div class="parent1">
        ...
        <div class="Noticias2">
            <a href="https://www.twitch.tv/n0guito" target="_blank">
                <img src="./img/bolassss (1).png" alt="Anuncio" width="100%">
            </a>
        </div>

        <div class="Noticias3">
            <img src="./img/operation-new-blood.png" alt="Noticia 3" width="100%">
        ...
        <div class="Noticias4">
            <img src="./img/tvyse.jpeg" alt="Noticia 4" width="100%">
        ...
        <div class="Noticias5">
            <img src="./img/arcane.png" alt="Noticia 5" width="100%">
        ...
        <div class="div1">
            <div class="card">
                <div class="face front">
                    <img class="imgTarjeta" src="./img/fortniteog2.png" alt="portadaFortnite">
                    <h3>Fortnite</h3>
                </div>
                <div class="face back">
                    <h3>Fortnite</h3>
                    ...
                    <div class="link">
                        <a href="./games/fornite/fornite.html">Mas</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="face front">
                    <img class="imgTarjeta" src="./img/lol.png" alt="imagen de league of Legends">
            ...
            <div class="card">
                <div class="face front">
                    <img class="imgTarjeta" src="./img/Portada-rainbow.png" alt="imagen de Rainbow">
                    <h3>Rainbow Six</h3>
                </div>
                <div class="face back">
                    <h3>Rainbow</h3>
            ...
            <div class="card">
                <div class="face front">
                    <img class="imgTarjeta" src="./img/valorant.png" alt="imagen de valorant">
                    <h3>Valorant</h3>
                </div>
                <div class="face back">
                    <h3>Valorant</h3>
