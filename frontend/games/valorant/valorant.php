        ...
        <main class=pagg>
                    ...
                    <div class="image-grid">
                        <div class="image-item">
                            <a class="image-caption" href="#">
                                <a href="#agentes" class="scroll-link"><img src="./img/agentes.png"
                                        alt="Imagen 1"></a>
                        ...
                        <div class="image-item">
                            <a class="image-caption" href="https://www.youtube.com/watch?v=EJR0rhvjGDk" target="_blank">
                                <img src="./img/armas.png" alt="Imagen 2">
                        ...
                        <div class="image-item">
                            <a class="image-caption" href="#">
                                <a href="#mapas" class="scroll-link"><img src="./img/mapas.jpg" alt="Imagen 5"></a>
                        ...
                        <div class="image-item">
                            <a class="image-caption"
                                ...
                                target="_blank">
                                <img src="./img/mejoraraim.jpg" alt="Imagen 6">
            ...
            <div class="portal2">
                ...
                <div class="image-grid2">
                    <div class="image-item2">
                        <img src="./img/163px-Astra_Artwork.png" alt="Imagen 1">
                        <p class="image-caption">Astra</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Breach_Artwork.png" alt="Imagen 2">
                        <p class="image-caption">Breach</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Brimstone_Artwork.png" alt="Imagen 3">
                        <p class="image-caption">Brimstone</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Chamber_Artwork.png" alt="Imagen 4">
                        <p class="image-caption">Chamber</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Cypher_Artwork.png" alt="Imagen 5">
                        <p class="image-caption">Cypher</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/147px-Deadlock_Artwork.png" alt="Imagen 6">
                    ...
                    <div class="image-item2">
                        <img src="./img/163px-Gekko_Artwork.png" alt="Imagen 8">
                        <p class="image-caption">Gekko</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Harbor_Artwork.png" alt="Imagen 9">
                        <p class="image-caption">Harbor</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Jett_Artwork.png" alt="Imagen 10">
                        <p class="image-caption">Jett</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-KAYO_Artwork.png" alt="Imagen 11">
                        <p class="image-caption">KAY/O</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Killjoy_Artwork.png" alt="Imagen 12">
                        <p class="image-caption">Killjoy</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Neon_Artwork.png" alt="Imagen 13">
                        <p class="image-caption">Neon</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Omen_Artwork.png" alt="Imagen 14">
                        <p class="image-caption">Omen</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Phoenix_Artwork.png" alt="Imagen 15">
                        <p class="image-caption">Phoenix</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Raze_Artwork.png" alt="Imagen 16">
                        <p class="image-caption">Raze</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Reyna_Artwork.png" alt="Imagen 17">
                        <p class="image-caption">Reyna</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Sage_Artwork.png" alt="Imagen 18">
                    ...
                    <div class="image-item2">
                        <img src="./img/163px-Skye_Artwork.png" alt="Imagen 19">
                        <p class="image-caption">Skye</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Sova_Artwork.png" alt="Imagen 20">
                        <p class="image-caption">Sova</p>
                        <button class="btnpj">Ataque</button><button class="btnpj">Defensa</button>
                    </div>
                    <div class="image-item2">
                        <img src="./img/163px-Viper_Artwork.png" alt="Imagen 21">
                    ...
                    <div class="image-item2">
                        <img src="./img/163px-Yoru_Artwork.png" alt="Imagen 22">
            ...
            <div class="portal3">
                ...
                <div class="image-grid3">
                    <div class="image-item2">
                        <a>
                            <img src="./img/ascent.png" alt="Imagen 1">
                            <p class="image-caption">Ascent</p>
                        </a>
                    </div>
                    <div class="image-item2">
                        <a>
                            <img src="./img/bind.png" alt="Imagen 2">
                            <p class="image-caption">Bind</p>
                        </a>
                    </div>
                    <div class="image-item2">
                        <a>
                            <img src="./img/haven.png" alt="Imagen 5">
                            <p class="image-caption">Haven</p>
                        </a>
                    </div>
                    <div class="image-item2">
                        <a>
                            <img src="./img/Lotus.png" alt="Imagen 7">
                            <p class="image-caption">Lotus</p>
                        </a>
                    </div>
                    <div class="image-item2">
                        <a>
                            <img src="./img/Split.png" alt="Imagen 9">
                            <p class="image-caption">Split</p>
                        </a>
                    </div>
                    <div class="image-item2">
                        <a>
                            <img src="./img/Sunset.png" alt="Imagen 10">
